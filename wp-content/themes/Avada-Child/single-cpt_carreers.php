	...
	<?php while ( have_posts() ) : ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
			...
			<div class="post-content">
                ...
                <?php if (!empty(get_post_meta(get_the_ID(), '_function', true))) : ?>
                    <h3><?php print __('Function') ?></h3>
                    <p><?php print html_entity_decode(get_post_meta(get_the_ID(), '_function', true)) ?></p>
                <?php endif; ?>

                <?php if (!empty(get_post_meta(get_the_ID(), '_profile', true))) : ?>
                    <h3><?php print __('Profile') ?></h3>
                    <p><?php print html_entity_decode(get_post_meta(get_the_ID(), '_profile', true)) ?></p>
                <?php endif; ?>

                <?php if (!empty(get_post_meta(get_the_ID(), '_offer', true))) : ?>
                    <h3><?php print __('Offer') ?></h3>
                    <p><?php print html_entity_decode(get_post_meta(get_the_ID(), '_offer', true)) ?></p>
                <?php endif; ?>

                <?php if (!empty(get_post_meta(get_the_ID(), '_interest', true))) : ?>
                    <h3><?php print __('Interest') ?></h3>
                    <p><?php print html_entity_decode(get_post_meta(get_the_ID(), '_interest', true)) ?></p>
                <?php endif; ?>

                <a href="<?php print get_post_type_archive_link( get_post_type() ) ?>"><?php print __('Terug naar overzicht') ?></a>
